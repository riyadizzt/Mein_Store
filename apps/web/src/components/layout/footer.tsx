      ...
      <div className="bg-[#0a0a0a] text-white/60">
        <div className="mx-auto max-w-[1440px] px-6 sm:px-8 lg:px-12 pt-14 sm:pt-18 pb-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16">
            ...
            <div className="col-span-1 md:col-span-3 grid grid-cols-3 gap-6 lg:gap-16">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  {departments.map((dept) => (
                    <FooterLink key={dept.id} href={`/${locale}/products?department=${dept.slug}`}>
                      {(dept as any).name ?? dept.slug}
                    </FooterLink>
                  ))}
                </ul>
              </div>
                ...
                <ul className="space-y-4">
                  ...
                  <li>
                    <button
                      ...
                      className="relative inline-flex items-center gap-1.5 text-[15px] text-white/50 hover:text-white transition-colors duration-200 pb-0.5 group"
                    >
          ...
          <div className="mt-8 flex flex-col items-center gap-5">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex items-center gap-2.5 flex-wrap justify-center">
                ...
                {/* Apple Pay */}
                <div className="h-9 w-[4.5rem] rounded-md bg-black border border-white/20 flex items-center justify-center" dir="ltr">
                ...
                {/* Google Pay */}
                <div className="h-9 w-[4.5rem] rounded-md bg-white border border-white/20 flex items-center justify-center" dir="ltr">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div dir="ltr" className="group relative flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-gradient-to-b from-white/[0.08] to-white/[0.04] border border-white/[0.08] hover:border-[#d4a853]/30 hover:from-white/[0.12] hover:to-white/[0.06] transition-all duration-300 cursor-default overflow-hidden">

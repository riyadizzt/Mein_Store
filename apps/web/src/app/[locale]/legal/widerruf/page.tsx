...
const TEXTS = {
  de: {
    ...
    returnText1: 'Die <strong>Rücksendung ist für Sie kostenlos</strong>. Nutzen Sie das Rücksendeetikett, das Ihnen per E-Mail zugesandt wird, oder fordern Sie eines über Ihr Kundenkonto an.',
  ...
  en: {
    ...
    returnTitle: 'Returns',
    returnText1: '<strong>Return shipping is free of charge</strong>. Use the return shipping label sent to you by email, or request one via your customer account.',
  ...
  ar: {
    ...
    returnTitle: 'الإرجاع',
    returnText1: '<strong>الإرجاع مجاني</strong>. استخدم ملصق الإرجاع الذي يُرسل إليك عبر البريد الإلكتروني، أو اطلب واحداً من حسابك.',
